...
namespace Sources.Core {
    ...
    public static class BoatController {
        ...
        private static void HandleSpeed(float dt, Boat boat, Wind wind) {
            // Voile au vent
			// vent   0 = voile [-10, +10]
			// vent -30 = voile [-30, -10]
			// vent +30 = voile [+10, +30]
            ...
            var sailWindward = boat.sailAngle >= minSailAngle && boat.sailAngle <= maxSailAngle;
